...
namespace ApiPeliculas.Migrations
{
    ...
    [Migration("20240521133632_TablasReviws")]
    partial class TablasReviws
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiPeliculas.Entities.PeliculaActor", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            PeliculaId = 4,
                            Orden = 1,
                            Personje = "Dr. Ivo Robotnik"
                        });
                });

            modelBuilder.Entity("ApiPeliculas.Entities.PeliculaGenero", b =>
                {
                    b.Property<int>("PeliculaId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiPeliculas.Entities.PeliculasSalasDeCine", b =>
                {
                    b.Property<int>("PeliculaId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiPeliculas.Entities.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiPeliculas.Entities.SalaDeCine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiPeliculas.Entities.PeliculasSalasDeCine", b =>
                {
                    ...
                    b.HasOne("ApiPeliculas.Entities.SalaDeCine", "SalaDeCine")
                        .WithMany("PeliculasSalasDeCines")
