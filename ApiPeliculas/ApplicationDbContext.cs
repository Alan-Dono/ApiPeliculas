        ...
        private void SeedData(ModelBuilder modelBuilder)
        {
           ...
           /* var geometryFactory = NtsGeometryServices.Instance.CreateGeometryFactory(srid: 4326);
            ...
            modelBuilder.Entity<PeliculaActor>().HasData(
                ...
                {
                    new PeliculaActor(){PeliculaId = endgame.Id, ActorId = robertDowney.Id, Personje = "Tony Stark", Orden = 1},
                    new PeliculaActor(){PeliculaId = endgame.Id, ActorId = chrisEvans.Id, Personje = "Steve Rogers", Orden = 2},
                    new PeliculaActor(){PeliculaId = iw.Id, ActorId = robertDowney.Id, Personje = "Tony Stark", Orden = 1},
                    new PeliculaActor(){PeliculaId = iw.Id, ActorId = chrisEvans.Id, Personje = "Steve Rogers", Orden = 2},
                    new PeliculaActor(){PeliculaId = sonic.Id, ActorId = jimCarrey.Id, Personje = "Dr. Ivo Robotnik", Orden = 1}
                });
        }
